...
| `IgnoreCachedErrors` | Reuse cached status codes (including errors) and don't retry them. Useful when post-processing the cache or to speed up repeated test runs with known broken links.                          | `false` |
